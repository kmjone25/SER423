...
class PlaceDescriptionJSON {
    ...
    var long:Double{
        didSet{
            if !(long <= 180.0 && lat >= -180.0) { long = 0.0}
        }
    }
    init(){
        self.name = ""
